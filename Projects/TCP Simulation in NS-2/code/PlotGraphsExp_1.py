# Utility script to parse results for experiment 1
import os
...
for file in traceFiles:
    ...
    if file.endswith('.tr'):
        ...
        for l in lines:
            ...
            # If tcp packet has been received at destination 3, add to throughput
            elif line[0] == 'r' and line[2] == '2' and line[3] == '3' and line[4] == 'tcp' and line[7] == '1':
                packetsReceived += 1
            ...
            elif line[0] == 'd' and line[7] == '1' and line[4] == 'tcp' and 'A' not in line[6]:
                packetsDropped += 1
        ...
        #print "file=" + str(file) + " Packets Dropped " + str(packetsDropped)+ " Throughput = " + str(throughputMbps) + " Goodput = " + str(goodputMbps) + " Drop Rate = " + str(packetDropRate) + " Latency = " + str(latency)
...
with open("results/exp3/Reno-DropTail-1.csv", 'w') as f:
